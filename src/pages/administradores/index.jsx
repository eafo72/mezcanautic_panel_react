...
const Administradores = () => {
  ...
  const actions = [
    
    {
      ...
      ActionToDo: (id) => {
        ...
        localStorage.setItem("EditAdministrador",id);
    ...
    },
    {
      ...
      ActionToDo: (id) => {
        ...
        localStorage.setItem("DeleteAdministrador",id);
        navigate("/administradores/borrar");
      },
    },
  ];
  ...
  const getAdministradores = async () => {
    try {
      const res = await clienteAxios.get(`/admin/admin/administradores`)
